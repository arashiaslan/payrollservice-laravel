        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">Form Catat Absensi</h3>
                    <p class="text-sm text-gray-500 mt-1">Isi data absensi pegawai dengan lengkap dan benar.</p>
                </div>

                {{-- Form --}}
                <form action="{{ route('attendances.store') }}" method="POST" class="px-6 py-6 space-y-5">
                    @csrf
