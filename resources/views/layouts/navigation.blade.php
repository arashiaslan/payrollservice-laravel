        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    {{-- Link Dashboard: tampil untuk semua user --}}
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        Dashboard
                    </x-nav-link>

                    {{-- Link Data Pegawai: hanya untuk admin --}}
                    @can('admin')
                    ...
                    {{-- Link Absensi: untuk semua user yang login --}}
                    <x-nav-link :href="route('attendances.index')" :active="request()->routeIs('attendances.*')">
                        Absensi
                    </x-nav-link>

                    {{-- Link Penggajian: untuk semua user yang login --}}
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            {{-- Badge role: tampilkan apakah Admin atau Pegawai --}}
                            <span class="ms-2 px-1.5 py-0.5 text-xs font-semibold rounded
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                {{-- Tampilkan badge role di menu mobile --}}
